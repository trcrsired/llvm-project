...
class CXXThisExpr;
class CXXThrowExpr;
class CXXErrorValueExpr;
class CXXTryExpr;
class CXXCatchFailsExpr;
...
ExprDependence computeDependence(CXXErrorValueExpr *E);
ExprDependence computeDependence(CXXTryExpr *E);
ExprDependence computeDependence(CXXCatchFailsExpr *E);
...
ExprDependence computeDependence(CXXThrowsExpr *E);
...
ExprDependence computeDependence(DependentTemplateIdExpr *E);
